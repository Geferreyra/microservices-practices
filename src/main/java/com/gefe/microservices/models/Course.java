...
public class Course implements Serializable {
	...
	private LocalDate start_date=ZonedDateTime.now(ZoneId.of("America/Buenos_Aires")).toLocalDate();
...
@JsonIdentityInfo(
	...
	public String toString() {
		return "Codigo: "+ key + " \nNombre:" + name + " \nEmpieza:" + start_date +"--"+ " Finaliza:" + ending_date
				 +"\nProfesor: "+ teacher ;
	}

//	@Override
//	public String toString() {
//		return "Course [key=" + key + ", name=" + name + ", start_date=" + start_date + ", ending_date=" + ending_date
//				+ ", teacher=" + teacher + "]";
//	}
